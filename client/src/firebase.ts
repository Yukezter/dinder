...
import { connectAuthEmulator, initializeAuth, browserLocalPersistence } from 'firebase/auth'
...
// Change default local persistance from IndexedDB to local storage for private browsing
