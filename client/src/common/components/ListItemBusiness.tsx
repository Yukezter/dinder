...
import { Avatar, Stars, OpenInNewLink } from '.'
import LikeIcon from '../icons/Like'
import SuperLikeIcon from '../icons/SuperLike'

interface ListItemBusinessProps extends ListItemProps {
  isLoading?: boolean
      ...
      <ListItemAvatar sx={{ mr: { xs: 1, sm: 3, lg: 1 } }}>
        {isLoading || !details ? (
          ...
          <div style={{ position: 'relative' }}>
            <Avatar src={details.image_url} variant='square' size={80} />
            {type === 'like' && (
              <LikeIcon
                style={{
                  position: 'absolute',
