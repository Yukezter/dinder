...
const ErrorCodes = {
  ...
  TOO_MANY_REQUESTS: 'We have blocked all requests from this device due to unusual activity. Try again later.',
  USERNAME_UNAVAILABLE: 'This username is taken.',
}
...
// type ErrorMap = {
//   [K in typeof AuthErrorCodes[keyof typeof AuthErrorCodes]]: string
// }

// // prettier-ignore
// var errors: Partial<ErrorMap> = {
//   "auth/admin-restricted-operation": "This operation is restricted to administrators only.",
//   "auth/argument-error": "Invalid argument(s) provided.",
...
//   "auth/user-signed-out": "Error while trying to sign out the current user.",
